...
ARG NEXT_PUBLIC_FREE_GIFT_PROMO_LABEL
ARG NEXT_PUBLIC_FREE_GIFT_MIN_SUBTOTAL
ARG NEXT_PUBLIC_SHOPIFY_LIVE_REFRESH_MS
ENV NEXT_PUBLIC_FREE_GIFT_PROMO_LABEL=$NEXT_PUBLIC_FREE_GIFT_PROMO_LABEL
ENV NEXT_PUBLIC_FREE_GIFT_MIN_SUBTOTAL=$NEXT_PUBLIC_FREE_GIFT_MIN_SUBTOTAL
ENV NEXT_PUBLIC_SHOPIFY_LIVE_REFRESH_MS=$NEXT_PUBLIC_SHOPIFY_LIVE_REFRESH_MS
