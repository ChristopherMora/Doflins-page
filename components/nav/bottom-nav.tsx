        ...
        {MOBILE_NAV_ITEMS.map(({ href, label }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className="relative flex min-h-[48px] min-w-[48px] flex-col items-center justify-center gap-0.5 px-5 text-[10px] font-bold uppercase tracking-[0.1em] transition active:scale-95"
            >
              {isActive && (
