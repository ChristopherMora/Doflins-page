  ...
  return (
    <>
      ...
      <div className="home-page-shell">
        <main className="mx-auto flex min-h-screen w-full max-w-6xl items-start px-5 py-6 pb-28 sm:px-8 sm:py-10 sm:pb-10">
          <div className="relative w-full space-y-16 sm:space-y-20">
            ...
            <section className="flex flex-col items-center gap-6 pt-8 text-center sm:pt-16">
              <div className="space-y-4">
                <h1 className="font-title text-5xl leading-[1.05] tracking-tight text-[var(--ink-900)] sm:text-6xl md:text-7xl">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3">
                <Button asChild size="lg" className="h-13 rounded-full px-8 text-base shadow-lg">
                  <Link href="#compras">
                    <SparklesIcon className="h-5 w-5" /> Comprar packs
                  </Link>
                </Button>
                <Button asChild variant="secondary" size="lg" className="h-13 rounded-full px-8 text-base">
              ...
              {/* Trust — minimal */}
              <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 pt-2 text-sm text-[var(--ink-500)]">
