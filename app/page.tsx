        ...
        <div className="w-full space-y-6">
          ...
          <Card className="w-full overflow-hidden border border-[#d3debb] bg-[linear-gradient(135deg,#f5f8e8,#e8f1d2,#d5e5b2)] shadow-[0_24px_50px_rgba(85,108,50,0.2)]">
            <CardContent className="space-y-5 p-8 text-center sm:p-12">
              {/* live badge */}
              <div className="inline-flex items-center gap-2 rounded-full border border-[#c6d99a] bg-white/70 px-4 py-1.5 text-xs font-semibold text-[var(--ink-700)]">
                <span
                  className="inline-block h-2 w-2 rounded-full bg-[var(--brand-primary)]"
              ...
              {/* mini stats */}
              <div className="flex flex-wrap items-center justify-center gap-3 pt-1 text-xs text-[var(--ink-700)]">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/60 px-3 py-1 ring-1 ring-[#cad89e]">
                  <CheckCircleIcon className="h-3.5 w-3.5 text-[var(--brand-primary)]" /> Pago seguro Shopify
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/60 px-3 py-1 ring-1 ring-[#cad89e]">
                  <FireIcon className="h-3.5 w-3.5 text-orange-500" /> Rarezas: Común → Legendaria
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/60 px-3 py-1 ring-1 ring-[#cad89e]">
                  <CheckCircleIcon className="h-3.5 w-3.5 text-[var(--brand-primary)]" /> Catálogo oficial QR
                </span>
                <LiveFigureCount />
              </div>
            </CardContent>
