      ...
      <main className="mx-auto min-h-screen w-full max-w-4xl px-4 py-8 pb-28 sm:px-8 sm:pb-12">
        ...
        <Card className="border-[#d3debb] bg-gradient-to-br from-white to-[#f9faf5]">
          <CardContent className="prose prose-sm max-w-none space-y-6 p-6 sm:p-8">
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">1. Aceptación de términos</h2>
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">2. Sobre DOFLINS</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">3. Uso del sitio</h2>
              <p className="text-[var(--ink-700)]">Te comprometes a:</p>
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">4. Compras y pagos</h2>
              <h3 className="font-semibold text-[var(--ink-900)]">4.1 Proceso de compra</h3>
              <p className="text-[var(--ink-700)]">
              ...
              <h3 className="font-semibold text-[var(--ink-900)]">4.2 Medios de pago</h3>
              <p className="text-[var(--ink-700)]">
                Aceptamos tarjetas de crédito/débito, OXXO, SPEI y otros métodos disponibles en la plataforma de pago.
              </p>

              <h3 className="font-semibold text-[var(--ink-900)]">4.3 Confirmación de pedido</h3>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">5. Packs sorpresa y rareza</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">6. Envíos</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">7. Devoluciones y reembolsos</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">8. Propiedad intelectual</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">9. Limitación de responsabilidad</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">10. Modificaciones</h2>
              <p className="text-[var(--ink-700)]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[var(--ink-900)]">11. Ley aplicable</h2>
              <p className="text-[var(--ink-700)]">
