      ...
      <main className="mx-auto min-h-screen w-full max-w-4xl px-4 py-8 pb-28 sm:px-8 sm:pb-12">
        ...
        <Card className="border-[#d3debb] bg-gradient-to-br from-white to-[#f9faf5]">
          <CardContent className="prose prose-sm max-w-none space-y-6 p-6 sm:p-8">
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">1. Responsable del tratamiento</h2>
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">2. Datos personales que recopilamos</h2>
              <p className="text-[#3d5230]">Para cumplir las finalidades previstas en este aviso, podemos recabar:</p>
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">3. Finalidades del tratamiento</h2>
              <p className="text-[#3d5230]">Sus datos personales serán utilizados para:</p>
              <ul className="list-disc pl-6 text-[#3d5230]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">4. Compartir información</h2>
              <p className="text-[#3d5230]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">5. Cookies y tecnologías de rastreo</h2>
              <p className="text-[#3d5230]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">6. Tus derechos (ARCO)</h2>
              <p className="text-[#3d5230]">Tienes derecho a:</p>
              <ul className="list-disc pl-6 text-[#3d5230]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">7. Seguridad de datos</h2>
              <p className="text-[#3d5230]">
            ...
            <section>
              <h2 className="font-title text-2xl text-[#1f2a1a]">8. Cambios al aviso de privacidad</h2>
              <p className="text-[#3d5230]">
